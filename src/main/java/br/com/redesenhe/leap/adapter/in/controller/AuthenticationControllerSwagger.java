...
@Tag(name = "Auth", description = "Operação para Login")
public interface AuthenticationControllerSwagger {

    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Login com sucesso", content = {
    ...
    ResponseEntity<UserAcessResponse> login(AuthenticationRequest authenticationRequest);
}
